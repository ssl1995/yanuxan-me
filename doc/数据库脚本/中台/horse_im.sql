...
MySQL - 5.7.34 : Database - horse_im
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`horse_im` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `message` (
  ...
  `from_id` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '消息发送人',
  ...
  KEY `session_idx` (`session_id`) USING BTREE
...
CREATE TABLE `session` (
  ...
  `update_user` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_deleted` tinyint(1) DEFAULT NULL COMMENT '是否删除 1-是 0-否',
...
CREATE TABLE `session_user` (
  ...
  `create_time_stamp` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `session_user_idx` (`session_id`,`user_id`)
...
CREATE TABLE `store_waiter` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='店铺下的客服';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='用户和客服实时绑定关系';
